const translations = {
    ru: {
        ...
        existing_images_label: "Изображения категории:",
        add_images_btn: "+ Добавить",
        repr_emoji_label: "Emoji для списка:",
        repr_emoji_ph: "🎨",
        file_zone_hint: "Перетащите или нажмите для выбора",
        file_zone_btn: "Выбрать файлы",
        ...
        ph_friend_username: "Имя пользователя",
        friend_request_sent: "Запрос отправлен!",
        friend_request_received_short: "хочет дружить с вами",
        friend_accepted: "{name} принял(а) ваш запрос",
        pending_requests_title: "Входящие запросы",
        friends_empty: "Друзей пока нет",
        requests_empty: "Нет входящих запросов",
        confirm_remove_friend: "Удалить {name} из друзей?",
        btn_accept: "Принять",
        btn_decline: "Отклонить",
        btn_remove_friend: "Удалить",
        btn_invite_game: "🎮 Пригласить",
        btn_open_dm: "💬 Написать",
        friend_game_invite: "{name} приглашает вас сыграть!",
        join_invite: "Войти",
        already_friends: "Уже в друзьях",
        cannot_add_self: "Нельзя добавить себя",
        request_exists: "Запрос уже отправлен",
        friend_game_badge: "Вас ждут!",
        invite_friend_lbl: "Пригласить друга:",
        no_friends_to_invite: "— Без приглашения —",
        invited_friend: "Зовём: ",
        dm_title: "личные сообщения",
        dm_ph_message: "Написать сообщение...",
        dm_send: "→",
    ...
    en: {
        ...
        existing_images_label: "Category images:",
        add_images_btn: "+ Add images",
        repr_emoji_label: "Emoji for list:",
        repr_emoji_ph: "🎨",
        file_zone_hint: "Drag & drop or click to choose",
        file_zone_btn: "Choose files",
        ...
        ph_friend_username: "Username",
        friend_request_sent: "Friend request sent!",
        friend_request_received_short: "wants to be your friend",
        friend_accepted: "{name} accepted your request",
        pending_requests_title: "Friend Requests",
        friends_empty: "No friends yet",
        requests_empty: "No incoming requests",
        confirm_remove_friend: "Remove {name} from friends?",
        btn_accept: "Accept",
        btn_decline: "Decline",
        btn_remove_friend: "Remove",
        btn_invite_game: "🎮 Invite",
        btn_open_dm: "💬 Message",
        friend_game_invite: "{name} invited you to play!",
        join_invite: "Join",
        already_friends: "Already friends",
        cannot_add_self: "Cannot add yourself",
        request_exists: "Request already sent",
        friend_game_badge: "You're invited!",
        invite_friend_lbl: "Invite friend:",
        no_friends_to_invite: "— No invite —",
        invited_friend: "Inviting: ",
        dm_title: "direct messages",
        dm_ph_message: "Write a message...",
        dm_send: "→",
